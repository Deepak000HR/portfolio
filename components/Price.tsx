  ...
  return (
    <div id={id} className="pt-[5rem] pb-[3rem] bg-black">
      ...
      <div className="w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 items-center pt-[4rem] md:pt-[7rem]">
        <PriceCard plan="Basic" save="10%" price="10$" bg="bg-red-900" />
        <PriceCard plan="Popular" save="30%" price="25$" bg="bg-green-900" />
        <PriceCard plan="Premium" save="60%" price="100$" bg="bg-blue-900" />
      </div>
    </div>
  );
};
