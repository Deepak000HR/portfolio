...
const BlogCard = ({ title, comment, date, image, link }: Props) => {
  return (
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mt-[2rem] justify-between">
          ...
          <button
            ...
            className="text-[15px] hover:text-yellow-500 transition-all duration-150 text-white font-semibold underline"
          >
            Read More
          </button>
        </div>
